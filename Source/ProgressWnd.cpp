...
CProgressWnd::CProgressWnd(CWnd* pParent, LPCTSTR pszTitle, BOOL bSmooth /* = FALSE */, BOOL bShowCancel /*= TRUE*/)
{
    CommonConstruct();
    m_strTitle = pszTitle;
...
void CProgressWnd::CommonConstruct()
{
	...
	// User should be able to set this
    //m_strTitle       = _T("Progress");
    //m_strCancelLabel = _T(" Cancel ");
	//m_strCancelLabel.LoadString(IDS_PROGRESS_WND_CANCEL);
