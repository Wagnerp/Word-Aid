// DownButton.cpp: implementation of the CDownButton class.
//
//////////////////////////////////////////////////////////////////////////////////////////
//																						//
//	WA0022 - make down button display constant size of triangle regardless of the size of	//
//			 the button																	//
//																						//
//////////////////////////////////////////////////////////////////////////////////////////
//																						//
...
CDownButton::CDownButton(CRect rect /*= CRect(0,0,0,0)*/, CString szName /*= _T("")*/,
...
void CDownButton::DrawButtonFace(CDC* pDC)
{
	CRgn	rgnArrow;
